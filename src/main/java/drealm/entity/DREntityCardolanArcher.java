...
public class DREntityCardolanArcher extends DREntityCardolanSoldier {
    public DREntityCardolanArcher(World world) {
        super(world);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        this.npcItemsInv.setRangedWeapon(new ItemStack(DRRegistry.cardolan_bow));
