...
public class DREntityArthedain extends LOTREntityMan {
    private static ItemStack[] weapons = new ItemStack[] {new ItemStack(DRRegistry.arthedain_sword), new ItemStack(LOTRMod.daggerIron), new ItemStack(DRRegistry.arthedain_spear), new ItemStack(DRRegistry.arthedain_axe), new ItemStack(LOTRMod.axeBronze), new ItemStack(Items.stone_axe)};
    public DREntityArthedain(World world) {
        super(world);
    ...
    public LOTRMiniQuest createMiniQuest() {
        return DRMiniQuestFactory.ARTHEDAIN.createQuest(this);
    }
    ...
    public LOTRMiniQuestFactory getBountyHelpSpeechDir() {
        return DRMiniQuestFactory.ARTHEDAIN;
    }
