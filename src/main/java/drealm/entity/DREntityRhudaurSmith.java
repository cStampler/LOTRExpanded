...
public class DREntityRhudaurSmith extends DREntityRhudaurMan implements LOTRTradeable.Smith {
    public static final LOTRTradeEntries RED_DWARF_SMITH_BUY = new LOTRTradeEntries(TradeType.BUY, new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_table), 100), new LOTRTradeEntry(new ItemStack(LOTRMod.blacksmithHammer), 18), new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_sword), 16), new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_spear), 18), new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_bow), 18), new LOTRTradeEntry(new ItemStack(DRRegistry.arthedain_pike), 18), new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_axe), 15), new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_pickaxe), 14), new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_shovel), 12), new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_helmet), 25), new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_chestplate), 36), new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_leggings), 30), new LOTRTradeEntry(new ItemStack(DRRegistry.rhudaur_boots), 22), new LOTRTradeEntry(new ItemStack(DRRegistry.brick,3, 8), 10));
    ...
    public DREntityRhudaurSmith(World world) {
        super(world);
