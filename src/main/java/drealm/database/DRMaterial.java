...
public class DRMaterial {
	...
	public static LOTRMaterial ARTHEDAIN = DRMaterial.newLOTRMaterial("ARTHEDAIN", 650, 3.0F, 0.7F, 7.0F, 3, 12, null);
	public static LOTRMaterial CARDOLAN = DRMaterial.newLOTRMaterial("CARDOLAN", 650, 3.0F, 0.7F, 7.0F, 3, 12, null);
	public static LOTRMaterial RHUDAUR = DRMaterial.newLOTRMaterial("RHUDAUR", 650, 3.0F, 0.7F, 7.0F, 3, 12, null);
