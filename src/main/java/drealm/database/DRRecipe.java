...
import drealm.block.DRBlockPillar;
...
public class DRRecipe {
	...
	public static List<IRecipe> arthedain = new ArrayList<>();
	public static List<IRecipe> rhudaur = new ArrayList<>();
	public static List<IRecipe> cardolan = new ArrayList<>();
	...
	public static void createRhudaurRecipes(){
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.rhudaur_table), "XX", "YY", Character.valueOf('X'), "plankWood", Character.valueOf('Y'), new ItemStack(Blocks.stone)));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.rhudaur_shovel), "X", "Y", "Y", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.rhudaur_pickaxe), "XXX", " Y ", " Y ", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.rhudaur_axe), "XX", "XY", " Y", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.rhudaur_sword), "X", "X", "Y", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.rhudaur_helmet), "XXX", "X X", Character.valueOf('X'), Items.iron_ingot));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.rhudaur_chestplate), "X X", "XXX", "XXX", Character.valueOf('X'), Items.iron_ingot));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.rhudaur_leggings), "XXX", "X X", "X X", Character.valueOf('X'), Items.iron_ingot));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.rhudaur_boots), "X X", "X X", Character.valueOf('X'), Items.iron_ingot));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.pillar, 3, 2), "X", "X", "X", Character.valueOf('X'), Blocks.stone));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(LOTRMod.banner, 1, DRItemBanner.RHUDAUR.bannerID), "X", "Y", "Z", Character.valueOf('X'), Blocks.wool, Character.valueOf('Y'), "stickWood", Character.valueOf('Z'), "plankWood"));
		rhudaur.add(new ShapedOreRecipe(new ItemStack(DRRegistry.brick, 4,3), "XX", "XX", Character.valueOf('X'), new ItemStack(Blocks.stone)));

	}
	public static void createArthedainRecipes() {
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.arthedain_table), "XX", "YY", Character.valueOf('X'), "plankWood", Character.valueOf('Y'), new ItemStack(Blocks.stone)));
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.arthedain_shovel), "X", "Y", "Y", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.arthedain_pickaxe), "XXX", " Y ", " Y ", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.arthedain_axe), "XX", "XY", " Y", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.arthedain_sword), "X", "X", "Y", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.arthedain_helmet), "XXX", "X X", Character.valueOf('X'), Items.iron_ingot));
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.arthedain_chestplate), "X X", "XXX", "XXX", Character.valueOf('X'), Items.iron_ingot));
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.arthedain_leggings), "XXX", "X X", "X X", Character.valueOf('X'), Items.iron_ingot));
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.arthedain_boots), "X X", "X X", Character.valueOf('X'), Items.iron_ingot));
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.pillar, 3, 1), "X", "X", "X", Character.valueOf('X'), Blocks.stone));
		arthedain.add(new ShapedOreRecipe(new ItemStack(LOTRMod.banner, 1, DRItemBanner.ARTHEDAIN.bannerID), "X", "Y", "Z", Character.valueOf('X'), Blocks.wool, Character.valueOf('Y'), "stickWood", Character.valueOf('Z'), "plankWood"));
		arthedain.add(new ShapedOreRecipe(new ItemStack(DRRegistry.brick, 4,2), "XX", "XX", Character.valueOf('X'), new ItemStack(Blocks.stone)));


	}

	public static void createCardolanRecipes(){
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.cardolan_table), "XX", "YY", Character.valueOf('X'), "plankWood", Character.valueOf('Y'), new ItemStack(Blocks.stone)));
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.cardolan_shovel), "X", "Y", "Y", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.cardolan_pickaxe), "XXX", " Y ", " Y ", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.cardolan_axe), "XX", "XY", " Y", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.cardolan_sword), "X", "X", "Y", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('Y'), "stickWood"));
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.cardolan_helmet), "XXX", "X X", Character.valueOf('X'), Items.iron_ingot));
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.cardolan_chestplate), "X X", "XXX", "XXX", Character.valueOf('X'), Items.iron_ingot));
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.cardolan_leggings), "XXX", "X X", "X X", Character.valueOf('X'), Items.iron_ingot));
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.cardolan_boots), "X X", "X X", Character.valueOf('X'), Items.iron_ingot));
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.pillar, 3, 3), "X", "X", "X", Character.valueOf('X'), Blocks.stone));
		cardolan.add(new ShapedOreRecipe(new ItemStack(LOTRMod.banner, 1, DRItemBanner.CARDOLAN.bannerID), "X", "Y", "Z", Character.valueOf('X'), Blocks.wool, Character.valueOf('Y'), "stickWood", Character.valueOf('Z'), "plankWood"));
		cardolan.add(new ShapedOreRecipe(new ItemStack(DRRegistry.brick, 4,4), "XX", "XX", Character.valueOf('X'), new ItemStack(Blocks.stone)));


	}
	public static void createRedMountainsRecipes() {
		red_mountains.add(new ShapedOreRecipe(new ItemStack(DRRegistry.red_dwarven_table), "XX", "YY", Character.valueOf('X'), "plankWood", Character.valueOf('Y'), new ItemStack(LOTRMod.brick)));
	...
	public static void preInit() {
		DRRecipe.createArthedainRecipes();
		DRRecipe.createRedMountainsRecipes();
		DRRecipe.createWindMountainsRecipes();
		DRRecipe.createRhudaurRecipes();
		DRRecipe.createCardolanRecipes();
