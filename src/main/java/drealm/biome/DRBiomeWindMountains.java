...
public class DRBiomeWindMountains extends LOTRBiome {
	...
	public DRBiomeWindMountains(int i, boolean major) {
		...
		decorator.addRandomStructure(new DRStructureWindMountainsStronghold(false), 1000);
		decorator.addRandomStructure(new DRStructureWindMountainsSmithy(false), 500);
