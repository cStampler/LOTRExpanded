...
import drealm.entity.DREntityRhudaurSmith;
...
public class DRStructureRhudaurSmith extends LOTRWorldGenStructureBase2 {
    ...
    public DRStructureRhudaurSmith(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        DREntityRhudaurSmith blacksmith = new DREntityRhudaurSmith(world);
