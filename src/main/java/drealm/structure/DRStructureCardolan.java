...
public abstract class DRStructureCardolan extends LOTRWorldGenStructureBase2 {
    ...
    public DRStructureCardolan(boolean flag) {
        super(flag);
    }
    ...
    protected ItemStack getRangerFramedItem(Random random) {
        ItemStack[] items = new ItemStack[] {new ItemStack(DRRegistry.cardolan_helmet), new ItemStack(DRRegistry.cardolan_chestplate), new ItemStack(DRRegistry.cardolan_leggings), new ItemStack(DRRegistry
                .cardolan_boots), new ItemStack(LOTRMod.daggerIron), new ItemStack(LOTRMod.daggerBronze), new ItemStack(DRRegistry.cardolan_bow), new ItemStack(Items.bow), new ItemStack(Items.arrow)};
