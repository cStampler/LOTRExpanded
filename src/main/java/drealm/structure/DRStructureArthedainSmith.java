...
public class DRStructureArthedainSmith extends DRStructureArthedain {
    public DRStructureArthedainSmith(boolean flag) {
        super(flag);
        ...
        public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
            ...
            DREntityArthedainSmith blacksmith = new DREntityArthedainSmith(world);
