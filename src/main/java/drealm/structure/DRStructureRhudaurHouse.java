...
public class DRStructureRhudaurHouse extends LOTRWorldGenStructureBase2 {
    ...
    public DRStructureRhudaurHouse(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        this.placeWallBanner(world, 0, 4, 5, DRItemBanner.RHUDAUR, 2);
        this.setBlockAndMetadata(world, -1, 3, 4, Blocks.skull, 2);
        this.setBlockAndMetadata(world, 1, 3, 4, Blocks.skull, 2);
        DREntityRhudaurMan hillman = new DREntityRhudaurMan(world);
