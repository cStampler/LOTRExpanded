...
import drealm.entity.DREntityCardolanSmith;
...
public class DRStructureCardolanSmith extends DRStructureCardolan {
    public DRStructureCardolanSmith(boolean flag) {
        super(flag);
        tableBlock = DRRegistry.cardolan_table;
        ...
        public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
            ...
            this.setBlockAndMetadata(world, 5, 1, -3, DRRegistry.cardolan_table, 0);
            ...
            this.setBlockAndMetadata(world, 1, 1, -3, DRRegistry.cardolan_table, 0);
            for(j12 = 1; j12 <= 3; ++j12) {
                for(i13 = -6; i13 <= -3; ++i13) {
                    for(k12 = 0; k12 <= 3; ++k12) {
            ...
            DREntityCardolanSmith blacksmith = new DREntityCardolanSmith(world);
