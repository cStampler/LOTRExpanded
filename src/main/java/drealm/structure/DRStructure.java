...
public class DRStructure {
	...
	public static void preInit() {
		...
		DRStructure.registerStructure(id++, DRStructureArthedainSmith.class, "ArthedainSmith",0x570000, 0x570000);
		DRStructure.registerStructure(id++, DRStructureArthedainCaptain.class, "ArthedainCaptain",0x570000, 0x570000);
		DRStructure.registerStructure(id++, DRStructureArthedainHouse.class, "ArthedainHouse",0x570000, 0x570000);
		DRStructure.registerStructure(id++, DRStructureArthedainVillage.class, "ArthedainVillage",0x570000, 0x570000);

		DRStructure.registerStructure(id++, DRStructureRhudaurHouse.class, "RhudaurHouse",0x570000, 0x570000);
		DRStructure.registerStructure(id++, DRStructureRhudaurVillage.class, "RhudaurVillage",0x570000, 0x570000);
		DRStructure.registerStructure(id++, DRStructureRhudaurCaptain.class, "RhudaurCaptain",0x570000, 0x570000);
		DRStructure.registerStructure(id++, DRStructureRhudaurSmith.class, "RhudaurSmith",0x570000, 0x570000);
