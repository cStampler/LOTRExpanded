...
public abstract class DRStructureArthedain extends LOTRWorldGenStructureBase2 {
    ...
    public DRStructureArthedain(boolean flag) {
        super(flag);
    }

    public DREntityArthedainCaptain createCaptain(World world) {
            return new DREntityArthedainCaptain(world);
        }
    ...
    protected ItemStack getRangerFramedItem(Random random) {
        ItemStack[] items = new ItemStack[] {new ItemStack(DRRegistry.arthedain_helmet), new ItemStack(DRRegistry.arthedain_chestplate), new ItemStack(DRRegistry.arthedain_leggings), new ItemStack(DRRegistry
                .arthedain_boots), new ItemStack(LOTRMod.daggerIron), new ItemStack(LOTRMod.daggerBronze), new ItemStack(DRRegistry.arthedain_bow), new ItemStack(Items.bow), new ItemStack(Items.arrow)};
