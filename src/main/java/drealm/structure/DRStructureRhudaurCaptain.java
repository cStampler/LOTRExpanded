...
public class DRStructureRhudaurCaptain extends LOTRWorldGenStructureBase2 {
    ...
    public DRStructureRhudaurCaptain(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        this.placeWallBanner(world, 0, 5, -5, LOTRItemBanner.BannerType.RHUDAUR, 2);
        this.placeWallBanner(world, -2, 5, -5, DRItemBanner.RHUDAUR, 2);
        this.placeWallBanner(world, 2, 5, -5, DRItemBanner.RHUDAUR, 2);
        for(i1 = -3; i1 <= 3; ++i1) {
        ...
        this.placeWallBanner(world, -3, 3, 0, DRItemBanner.RHUDAUR, 1);
        this.setBlockAndMetadata(world, 2, 5, 0, Blocks.torch, 1);
        this.placeWallBanner(world, 3, 3, 0, DRItemBanner.RHUDAUR, 3);
        for(k13 = -3; k13 <= -1; ++k13) {
        ...
        for(j16 = 0; j16 >= -5; --j16) {
            for(int i16 = -1; i16 <= 1; ++i16) {
                for(int k16 = -1; k16 <= 1; ++k16) {
                    ...
                    this.setBlockAndMetadata(world, i16, j16, k16, DRRegistry.brick, 3);
                }
            }
        }
        ...
        this.setBlockAndMetadata(world, -2, 1, 3, DRRegistry.rhudaur_table, 0);
        ...
        DREntityRhudaurCommander chieftain = new DREntityRhudaurCommander(world);
