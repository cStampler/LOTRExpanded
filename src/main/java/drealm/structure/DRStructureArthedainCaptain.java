...
import drealm.entity.DREntityArthedainCaptain;
import drealm.entity.DREntityArthedainSmith;
import drealm.entity.DREntityRhudaurCommander;
...
public class DRStructureArthedainCaptain extends DRStructureArthedain {
    public DRStructureArthedainCaptain(boolean flag) {
        super(flag);
        tableBlock = DRRegistry.arthedain_table;
        ...
        public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
            ...
            for(i12 = 7; i12 <= 9; ++i12) {
                for(k1 = -1; k1 <= 1; ++k1) {
                    for(int j15 = 5; (((j15 >= 0) || !this.isOpaque(world, i12, j15, k1)) && (this.getY(j15) >= 0)); --j15) {
                        this.setBlockAndMetadata(world, i12, j15, k1, DRRegistry.brick, 2);
            ...
            for(int j16 = 6; j16 <= 7; ++j16) {
                this.setBlockAndMetadata(world, 8, j16, 0, DRRegistry.brick, 2);
            }
            ...
            this.setBlockAndMetadata(world, 5, 1, -3, DRRegistry.arthedain_table, 0);
            ...
            this.setBlockAndMetadata(world, 1, 1, -2, LOTRMod.rangerTable, 0);
            this.setBlockAndMetadata(world, 1, 1, -3, DRRegistry.arthedain_table, 0);
            for(j12 = 1; j12 <= 3; ++j12) {
                for(i13 = -6; i13 <= -3; ++i13) {
                    for(k12 = 0; k12 <= 3; ++k12) {
                        this.setBlockAndMetadata(world, i13, j12, k12, DRRegistry.brick, 2);
                    }
                }
                this.setBlockAndMetadata(world, -2, j12, 3, DRRegistry.brick, 2);
            }
            for(j12 = 1; j12 <= 3; ++j12) {
            ...
            for(k14 = -2; k14 <= 2; ++k14) {
                for(i13 = -5; i13 <= -3; ++i13) {
                    this.setBlockAndMetadata(world, i13, 4, k14, DRRegistry.brick, 2);
                }
            }
            for(k14 = -1; k14 <= 1; ++k14) {
                this.setBlockAndMetadata(world, -4, 5, k14, DRRegistry.brick, 2);
            }
            ...
            DREntityArthedainCaptain captain = new DREntityArthedainCaptain(world);
