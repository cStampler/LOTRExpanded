...
public class DRStructureCardolanHouse extends DRStructureCardolan {
    public DRStructureCardolanHouse(boolean flag) {
        super(flag);
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        block54: {
                ...
                for(k13 = -3; k13 <= 3; ++k13) {
                    ...
                    if(i15 >= 5 && k2 <= 1) {
                        for(j12 = 5; (((j12 >= 0) || !this.isOpaque(world, i15, j12, k13)) && (this.getY(j12) >= 0)); --j12) {
                            this.setBlockAndMetadata(world, i15, j12, k13, DRRegistry.brick, 4);
            ...
            this.setBlockAndMetadata(world, 0, 0, -3, DRRegistry.brick, 4);
            ...
            for(int j14 = 6; j14 <= 7; ++j14) {
                this.setBlockAndMetadata(world, 6, j14, 0, DRRegistry.brick, 4);
            }
            ...
            this.setBlockAndMetadata(world, -1, 1, 1, DRRegistry.cardolan_table, 0);
        ...
        for(int l = 0; l < men; ++l) {
            DREntityCardolan dunedain = new DREntityCardolan(world);
