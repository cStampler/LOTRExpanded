...
public class DREventHandler {
	...
	public void onCrafting(PlayerEvent.ItemCraftedEvent event) {
		...
		} else if (container instanceof DRBlockTableArthedain.Container){
			LOTRLevelData.getData(player).addAchievement(DRAchievement.use_arthedain_table);
		}
		  else if (container instanceof DRBlockTableRhudaur.Container){
		    LOTRLevelData.getData(player).addAchievement(DRAchievement.use_arthedain_table);
	}
	}
