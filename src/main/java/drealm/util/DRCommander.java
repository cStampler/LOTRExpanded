...
public class DRCommander {
	...
	public static LOTRItemBanner.BannerType addBanner(String name, LOTRFaction faction) {
		...
		Map map = ReflectionHelper.getPrivateValue(BannerType.class, null, "bannerForID");
	...
	public static LOTRFactionRank addFactionRank(LOTRFaction faction, float alignment, String name, boolean gendered) {
		return findAndInvokeMethod(new Object[] { Float.valueOf(alignment), name, gendered }, LOTRFaction.class, faction, "addRank", Float.TYPE, String.class, Boolean.TYPE);
	}
	...
	public static void addNameBanks(Map<String, String[]> nameBanks) {
		Map allNameBanks = ReflectionHelper.getPrivateValue(LOTRNames.class, null, "allNameBanks");
	...
	public static void addSpeechBank(String name, boolean rand, List<String> lines) {
		...
		Map allSpeechBanks = ReflectionHelper.getPrivateValue(LOTRSpeech.class, null, "allSpeechBanks");
	...
	public static void addSTRScans(Map<String, LOTRStructureScan> scans) {
		Map allScans = ReflectionHelper.getPrivateValue(LOTRStructureScan.class, null, "allLoadedScans");
