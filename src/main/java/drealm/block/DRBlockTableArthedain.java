...
public class DRBlockTableArthedain extends LOTRBlockCraftingTable {
    @SideOnly(value = Side.CLIENT)
    private IIcon[] tableIcons;

    public DRBlockTableArthedain() {
        super(Material.rock, DRFaction.ARTHEDAIN, 2);
    ...
    public static class Container extends LOTRContainerCraftingTable {
        public Container(InventoryPlayer inv, World world, int i, int j, int k) {
            super(inv, world, i, j, k, DRRecipe.arthedain, DRRegistry.arthedain_table);
        }
    }
    ...
    public static class Gui extends LOTRGuiCraftingTable {
        public Gui(InventoryPlayer inv, World world, int i, int j, int k) {
            super(new Container(inv, world, i, j, k), "arthedain");
        }
    }
}
